	...
	<nav class="navbar navbar-expand-sm bg-light">
		...
		<ul class="navbar-nav">
			...
			<li class="nav-item"><a class="nav-link"
				href="${contextPath }/board/list">게시판</a></li>
			...
			<c:if test="${not empty sessionScope.email}">
				<li class="nav-item">
					<form action="${contextPath }/member/logout" id="logoutForm"
						method="post">
			...
			<li class="nav-item"><a class="nav-link"
				href="${contextPath }/member/list">회원목록</a></li>
			<li class="nav-item"><a class="nav-link"
				href="${contextPath }/member/register">회원가입</a></li>
		</ul>
	</nav>
